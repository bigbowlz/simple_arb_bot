...
Every 5 seconds, the whale trades ETH for another random baseAsset 
...
if __name__ == "__main__":
    ...
    # Transaction sent by the whale address through whale_arb_bot setup, trading between $30,000 and $100,000 in a single swap.
